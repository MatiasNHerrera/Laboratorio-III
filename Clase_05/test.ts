...
http.onreadystatechange = () =>
{
    ...
    {
        let table = "<table border='1'><tr><td>Id</td> <td>Marca</td> <td>Precio</td> <td>Color</td> <td>Modelo</td> <td>Acciones</td></tr>";
        var autos : any[] = JSON.parse(http.responseText);
        var i = 0;
